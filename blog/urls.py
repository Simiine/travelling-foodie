...
urlpatterns = [
    ...
    path('experience_delete/<slug:slug>', views.ExperienceDeleteView.as_view(), name='experience_delete'),
    path('delete_comment/<int:pk>', views.ExperienceDeleteComment.as_view(), name='delete_comment'),
]